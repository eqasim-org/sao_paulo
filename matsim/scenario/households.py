...
FIELDS = ["household_id", "person_id", "household_income", "binary_car_availability"]
...
def add_household(writer, household, member_ids):
    ...
    writer.add_attribute("carAvailability", "java.lang.String", household[FIELDS.index("binary_car_availability")])
